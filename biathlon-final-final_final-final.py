...
def game_round(n_prob, n, prob):
    ...
    if n_prob > prob: # jämför den eventuellt nya, och då större, sannolikheten för att se om det blev träff eller inte
        if target == 0:
            ...
            print("\nHit on open target") # vid träff på öppet target plussa på en räknare
            tavla[t-1] = 0
            # return poäng av något slag True/False
    else: # miss
        print("\nMiss")
...
def main():
    ...
    while n < 6:
        ...
        game_round(n_prob, n, prob) # göra detta till variabel som räknar poäng
